export default function Section1() {
  return (
    <section className="relative w-full overflow-hidden" style={{ minHeight: "340px" }}>
      ...
      {/* Content */}
      <div
        className="relative z-cv-raised flex flex-col items-center justify-center text-center px-cv-lg py-cv-5xl"
      ...
      >
        ...
        <h2
          className="m-0 font-cv-serif italic font-cv-regular leading-cv-snug text-cv-gold"
          style={{ fontSize: "clamp(32px, 5vw, 68px)" }}
        >
        ...
        >
          Precision in{" "}
          <span className="font-cv-bold">Every Laser.</span>
        </h2>
      </div>
    </section>
  );
