export default function StudioSection() {
  return (
    <div className="flex flex-col sm:flex-row w-full bg-cv-soft font-cv-sans py-cv-4xl">

      {/* Left Panel */}
      <div className="sm:w-[44%] px-cv-2xl flex flex-col justify-center">

        <h2 className="font-cv-serif text-cv-2xl font-cv-regular text-cv-black tracking-cv-tight leading-cv-snug m-0 mb-cv-lg">
          The Studio
        </h2>

        <p className="font-cv-sans text-cv-sm font-cv-regular text-cv-charcoal leading-cv-relaxed m-0 mb-cv-xl max-w-[420px]">
        ...
        <div className="flex items-center gap-cv-md">
          <div className="w-cv-xl h-cv-xl rounded-cv-full bg-cv-soft flex items-center justify-center shrink-0">
      ...
      <div className="flex-1 px-cv-2xl flex flex-col justify-start mt-cv-xl sm:mt-0">
        ...
        <p className="font-cv-sans text-cv-label tracking-cv-widest text-cv-muted uppercase font-cv-regular m-0 mb-cv-lg">
          Engagement Process
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-cv-xl gap-x-cv-2xl">
          {[
            ...
            <div key={step.num}>
              <h3 className="font-cv-serif italic font-cv-regular text-cv-lg text-cv-gold m-0 mb-cv-sm">
                {step.num} {step.title}
              </h3>
              <p className="font-cv-sans text-cv-label tracking-cv-wide uppercase text-cv-muted leading-cv-relaxed m-0 font-cv-regular">
                {step.desc}
              </p>
            </div>
          ))}
